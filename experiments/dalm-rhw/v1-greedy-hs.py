...
CONFIG_NICKS = [
    ...
    ("dalm-rhw-greedy-hs", ["--search",
                 "let(hlm, dalm_greedy_hs(dalm_reasonable_orders_hps(dalm_rhw()), transform=adapt_costs(one)), lazy_greedy([hlm], preferred=[hlm], cost_type=one, reopen_closed=false))"]),
]
CONFIGS = [
    IssueConfig(
        config_nick,
