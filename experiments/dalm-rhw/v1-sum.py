...
CONFIG_NICKS = [
    ...
    ("dalm-rhw-sum", ["--search",
                 "let(hlm, dalm_sum(dalm_reasonable_orders_hps(dalm_rhw()), transform=adapt_costs(one)), lazy_greedy([hlm], preferred=[hlm], cost_type=one, reopen_closed=false))"]),
