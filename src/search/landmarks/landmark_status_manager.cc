...
bool LandmarkStatusManager::process_state_transition(
    ...
    /*
       Set all non-past landmarks of this parent as "not past". Over multiple
       paths, this has the effect of computing the intersection of "past" for
       the parents. It is important here that upon first visit, all elements in
    ...
    */
    ...
    // Mark landmarks reached right now as "past" (if they are "leaves").
